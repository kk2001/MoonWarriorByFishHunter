    ...
    int       nCmdShow)
{
    ...
    return MoonwarriorbyquickPlayer::createAndRun();
}

int MoonwarriorbyquickPlayer::createAndRun(void)
{
    MoonwarriorbyquickPlayer *host = MoonwarriorbyquickPlayer::sharedInstance();
    int ret = host->run();
    MoonwarriorbyquickPlayer::purgeSharedInstance();
    return ret;
}

MoonwarriorbyquickPlayer *MoonwarriorbyquickPlayer::s_sharedInstance = NULL;

MoonwarriorbyquickPlayer *MoonwarriorbyquickPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new MoonwarriorbyquickPlayer();
    }
    return s_sharedInstance;
}

void MoonwarriorbyquickPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
MoonwarriorbyquickPlayer::MoonwarriorbyquickPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int MoonwarriorbyquickPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "moonwarriorbyquick-player");
...
void MoonwarriorbyquickPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void MoonwarriorbyquickPlayer::createViewMenu(void)
{
...
void MoonwarriorbyquickPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void MoonwarriorbyquickPlayer::updateWindowTitle(void)
{
}

void MoonwarriorbyquickPlayer::relaunch(void)
{
...
void MoonwarriorbyquickPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void MoonwarriorbyquickPlayer::onFileOpenProject(void)
{
...
void MoonwarriorbyquickPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"MoonwarriorbyquickPlayer");
...
void MoonwarriorbyquickPlayer::onFileProjectConfig(void)
{
...
void MoonwarriorbyquickPlayer::onFileRelaunch(void)
{
    relaunch();
}

void MoonwarriorbyquickPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void MoonwarriorbyquickPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void MoonwarriorbyquickPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void MoonwarriorbyquickPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void MoonwarriorbyquickPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT MoonwarriorbyquickPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    MoonwarriorbyquickPlayer *host = MoonwarriorbyquickPlayer::sharedInstance();
...
INT_PTR CALLBACK MoonwarriorbyquickPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
