...
class CC_DLL MoonwarriorbyquickPlayer : public CCObject
{
public:
...
private:
    static MoonwarriorbyquickPlayer *s_sharedInstance;
    static MoonwarriorbyquickPlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    MoonwarriorbyquickPlayer(void);
